...
const HeroSection = () => {
  return (
    <div className="h-[40rem] rounded-md bg-darkBackground flex flex-col items-center justify-center relative w-full mt-8">
  <div className="relative flex-col md:flex-row z-10 text-2xl sm:text-3xl md:text-4xl lg:text-[5.5rem] md:leading-tight max-w-7xl mx-auto text-center font-medium bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-white to-white flex items-center gap-2 md:gap-8">
    <HeroHighlight>
      <motion.div
      ...
      >
        <motion.h1
          ...
          animate={{ opacity: 1, y: [20, -5, 0] }}
          transition={{ duration: 0.5, ease: [0.4, 0.0, 0.2, 1] }}
          className="text-[2.0rem] sm:text-5xl md:text-6xl lg:text-[5.6rem] font-bold text-neutral-700 dark:text-white md:max-w-6xl leading-relaxed lg:leading-snug"
        >
